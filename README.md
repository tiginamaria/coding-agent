...
This creates a self-contained distribution in `build/install/coding-agent/` with:
```
build/install/coding-agent/
├── bin/
│   ├── coding-agent          # Unix/Linux/macOS executable
│   └── coding-agent.bat      # Windows executable
└── lib/
...
```bash
# Unix/Linux/macOS
ls -lh build/install/coding-agent/bin/coding-agent

# Windows
dir build\install\coding-agent\bin\coding-agent.bat
```
...
```json
{
    "agent_servers": {
        "Koog Agent": {
            "command": "/absolute/path/to/coding-agent/build/install/coding-agent/bin/coding-agent",
            "args": [],
            "env": {
...
```json
{
    "agent_servers": {
        "Koog Agent": {
            "command": "/Users/username/IdeaProjects/coding-agent/build/install/coding-agent/bin/coding-agent",
            "args": [],
            "env": {
...
```json
{
    "agent_servers": {
        "Koog Agent": {
            "command": "C:\\Users\\username\\IdeaProjects\\coding-agent\\build\\install\\coding-agent\\bin\\coding-agent.bat",
            "args": [],
            "env": {
                "OPENAI_API_KEY": "sk-proj-..."
            }
